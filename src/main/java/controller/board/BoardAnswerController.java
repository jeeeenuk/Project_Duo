...
import data.service.board.BoardAnswerService;
...
public class BoardAnswerController {
                             ...
                             HttpSession session)
    {
        ...
        String tableName = userService.userFindTable(myid);
        //아이디에 해당하는 이름 얻기
        String writer=userService.selectByID(myid, tableName).getName();
        //dto 에 필요한 데이터 넣기
